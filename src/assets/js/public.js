...
//GET,Promise请求
export const getPromise = (url, data) => {
  return new Promise(function (relove, reject) {
    var xhr = null;
    if (window.XMLHttpRequest) {
      xhr = new XMLHttpRequest();
...
//http://192.168.3.4
export const getNewStr = 'http://tour.1000da.com.cn/ajaxhandler.ashx'; //'http://sos.1000da.com.cn' //'http://192.168.3.50'http://hly.1000da.com.cn
